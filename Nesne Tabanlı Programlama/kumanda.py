...
class Kumanda():
    ...
    def kanal_sil(self,kanalno):

        print("Silinen kanal: {}".format(self.kanal_listesi[kanalno-1]))
        del (self.kanal_listesi[kanalno-1])
...
while True:
    ...
    if (işlem == "q"):
        ...
        kanal = int(input("Kacıncı kanalı sileceksiniz?:"))
